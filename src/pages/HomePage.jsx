          ...
          <Container>
            <Row className="header-box d-flex align-items-center overflow-hidden">
              <Col lg="6">
                ...
                <button className="btn btn-danger btn-lg rounded-1 me-2 mb-2 fw-medium" onClick={() => navigate("kelas")}>Lihat Kelas</button>
                <button className="btn btn-outline-danger btn-lg rounded-1 mb-2 fw-medium" onClick={() => navigate("kelas")}>Lihat Promo</button>
              </Col>
              <Col lg="6">
